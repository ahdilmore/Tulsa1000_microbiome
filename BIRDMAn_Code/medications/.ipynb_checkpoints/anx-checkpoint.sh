...
TABLEID="gad_birdman_table"
TABLE="/projects/u19/Tulsa/final_tables/"$TABLEID".biom"
OUTDIR="/projects/u19/Tulsa/birdman/medications/inferences/anxiety"
LOGDIR="/projects/u19/Tulsa/birdman/medications/logs/"$TABLEID
mkdir -p $OUTDIR
mkdir -p $LOGDIR

echo Starting Python script...
time python /projects/u19/Tulsa/birdman/src/anx_birdman_chunked.py \
    --table-path $TABLE \
