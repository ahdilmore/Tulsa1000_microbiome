...
#SBATCH --output=/projects/u19/Tulsa/birdman/medications/slurm_out/%x.out
...
for inference_dir in glob.glob('/projects/u19/Tulsa/birdman/medications/inferences/*'):
