...
MD = pd.read_table("/projects/u19/Tulsa/final_tables/metadata_full.tsv", sep="\t", index_col=0)

class AntidepressantsModelSingle(SingleFeatureModel):
    def __init__(
        self,
        table: biom.Table,
        feature_id: str,
        ...
        **kwargs
        ...
        A = np.log(1 / D) 
        # build formula
        self.create_regression(formula="N06A_Antidepressants+Age+Gender+cobre+InBody_BMI", metadata=MD)
