...
MD = pd.read_table("/projects/u19/Tulsa/data_updated/metadata.tsv", sep="\t", index_col=0)

class GroupModelSingle(SingleFeatureModel):
    def __init__(
        self,
        table: biom.Table,
        feature_id: str,
        ...
        **kwargs
        ...
        A = np.log(1 / D) 
	# build formula
        self.create_regression(formula="GroupAssignment+Gender+Medicated+Age", metadata=MD)
